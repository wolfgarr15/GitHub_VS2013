...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), "square.txt", L"stone01.dds", L"lightmap01.dds");
	if (!result)
	{
...
bool GraphicsClass::Render()
{
	...
	result = m_LightMapShader->Render(m_D3D->GetDeviceContext(), m_Model->GetIndexCount(), 
