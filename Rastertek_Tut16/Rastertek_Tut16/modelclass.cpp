...
bool ModelClass::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* texFilename1, WCHAR* texFilename2, WCHAR* alphaFilename)
{
	bool result;
	...
	result = LoadTextures(device, texFilename1, texFilename2, alphaFilename);
	if (!result)
		return false;
...
bool ModelClass::LoadTextures(ID3D11Device* device, WCHAR* texFilename1, WCHAR* texFilename2, WCHAR* alphaFilename)
{
	bool result;
	...
	result = m_textureArray->Initialize(device, texFilename1, texFilename2, alphaFilename);
	if (!result)
		return false;
