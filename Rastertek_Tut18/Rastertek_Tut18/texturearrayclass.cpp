...
bool TextureArrayClass::Initialize(ID3D11Device* device, WCHAR* texFilename1, WCHAR* texFilename2, WCHAR* texFilename3)
{
	HRESULT result;
	...
	result = D3DX11CreateShaderResourceViewFromFileW(device, texFilename3, NULL, NULL, &m_textures[2], NULL);
	if (FAILED(result))
		return false;
