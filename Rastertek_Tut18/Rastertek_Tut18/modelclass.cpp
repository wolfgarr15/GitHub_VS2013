...
bool ModelClass::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* texFilename, WCHAR* bumpMapFilename, WCHAR* specMapFilename)
{
	bool result;
	...
	// Calculate the normal, tangent, and binormal vectors.
	...
	result = LoadTextures(device, texFilename, bumpMapFilename, specMapFilename);
	if (!result)
		return false;
...
bool ModelClass::LoadTextures(ID3D11Device* device, WCHAR* texFilename, WCHAR* bumpMapFilename, WCHAR* specMapFilename)
{
	bool result;
	...
	result = m_textureArray->Initialize(device, texFilename, bumpMapFilename, specMapFilename);
	if (!result)
		return false;
...
void ModelClass::CalculateModelVectors()
{
	...
	// Go through all the faces and calculate the normal, tangent, and binormal.
