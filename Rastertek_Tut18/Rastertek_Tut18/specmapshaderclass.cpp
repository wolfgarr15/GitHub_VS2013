...
SpecMapShaderClass::SpecMapShaderClass(const SpecMapShaderClass& src) {}
...
bool SpecMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"vsSpecMap.hlsli", L"psSpecMap.hlsli");
	if (!result)
		return false;
...
bool SpecMapShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DX11CompileFromFileW(vsFilename, NULL, NULL, "SpecMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFileW(psFilename, NULL, NULL, "SpecMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
											...
											D3DXVECTOR3 cameraPosition, D3DXVECTOR4 specularColor, float specularPower)
{
	...
	// Set the updated camera buffer in the vertex shader.
