...
LightShaderClass::LightShaderClass(const LightShaderClass& src) {}
...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"vsLight.hlsli", L"psLight.hlsli");
	if (!result)
		return false;
								...
								D3DXVECTOR3 cameraPosition, float specularPower, D3DXVECTOR4 specularColor)
{
	...
	result = SetShaderParameters(deviceContext, 
								...
								cameraPosition, specularPower, specularColor);
	if (!result)
		return false;
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DX11CompileFromFileW(vsFilename, NULL, NULL, "LightVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFileW(psFilename, NULL, NULL, "LightPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	// Create the camera buffer from the description.
											...
											D3DXVECTOR3 cameraPosition, float specularPower, D3DXVECTOR4 specularColor)
{
	...
	// Get a pointer to the camera buffer.
	dataPtr3 = (CameraBufferType*)mappedResource.pData;

	// Copy the camera data to the buffer.
	...
	// Set the camera buffer in the vertex shader.
