...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Floor->Initialize(m_D3D->GetDevice(), "floor.txt", L"blue01.dds");
	if (!result)
	{
		MessageBox(hwnd, "Could not initialize the model object.", "Error", MB_OK);
		return false;
	...
	// Initialize the reflection shader.
...
bool GraphicsClass::RenderScene()
{
	...
	result = m_ReflectionShader->Render(m_D3D->GetDeviceContext(), m_Floor->GetIndexCount(), worldMatrix, viewMatrix,
		projectionMatrix, m_Floor->GetTexture(), m_RenderTexture->GetShaderResourceView(),
		reflectionMatrix);
