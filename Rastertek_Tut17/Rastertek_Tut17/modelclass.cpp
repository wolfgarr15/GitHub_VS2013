...
bool ModelClass::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* texFilename, WCHAR* bumpMapFilename)
{
	bool result;
	...
	result = LoadTextures(device, texFilename, bumpMapFilename);
	if (!result)
		return false;
...
bool ModelClass::LoadTextures(ID3D11Device* device, WCHAR* texFilename, WCHAR* bumpMapFilename)
{
	bool result;
	...
	result = m_textureArray->Initialize(device, texFilename, bumpMapFilename);
	if (!result)
		return false;
